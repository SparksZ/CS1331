...
/**
* This manages the messages list and the body of the messages
* @author Zack Sparks
* @version 1.0
*/
public class MessagesWindow {
    private Server getServed;
    private String activeBox;
    private Mailbox inbox;
    private Mailbox important;
    private Mailbox trash;
    private ListView<String> list;
    private ObservableList<String> mSendSub;
    private VBox mBox;
    ...
    */
    ...
    /**
    * @return the ObservableList get mSendSub (holds the Messages Subjects)
    */
    public ObservableList<String> getMSendSub() {
        return mSendSub;
    }
