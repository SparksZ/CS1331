...
public class MailReader extends Application {
    ...
    */
    ...
    public void start(Stage stage) throws Exception {
        ...
        border.setTop(HeaderMaker.addHeader());
        border.setLeft(MailBoxChoiceMaker.addMailBoxes());
        border.setCenter(MessageSubjectListMaker.messageList("Inbox"));
        border.setRight(BodyReaderMaker.displayMessage());
        // border.setRight(messWin.displayMessage());
